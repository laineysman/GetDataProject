@@ -1,52 +0,0 @@
# Source data from the UCI HAR Dataset
# This script merges the training and the test data into one dataset
# then performs some calculations on the complete dataset
